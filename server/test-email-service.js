...
async function testOrderConfirmation() {
  ...
  try {
    const result = await send_order_email(TEST_EMAIL, orderData, 'confirmation');
...
async function testOrderCancellation() {
  ...
  try {
    const result = await send_order_email(TEST_EMAIL, orderData, 'cancellation');
...
async function runAllTests() {
  ...
  console.log('\n📚 For more help, check the README_EMAIL_SERVICE.md file.');
}
